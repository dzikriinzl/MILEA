.class public final Lo/UnitTrustInvestmentManagerListFragment;
.super Ljava/lang/Object;
.source ""


# direct methods
.method public static final a(Lo/getGoalMaxDateYear;Lo/DecorationKTwxG1Y;Z)Lo/MutualFundGoalTopUpTransactionFormViewModel_HiltModulesKeyModule;
    .locals 33
    ...
    .line 128
    invoke-virtual/range {p0 .. p0}, Lo/getGoalMaxDateYear;->getTransactionDetails()Ljava/util/List;
    ...
    .line 128
    invoke-static {v5}, Lo/UnitTrustInvestmentManagerListFragment;->read(Lo/getTotalAmountTrx;)Lo/MutualFundSwitchingConfirmationViewModel;
    ...
    .line 130
    invoke-virtual/range {p0 .. p0}, Lo/getGoalMaxDateYear;->getNominal()Ljava/lang/String;
    ...
    .line 131
    invoke-virtual/range {p0 .. p0}, Lo/getGoalMaxDateYear;->getTransactionId()Ljava/lang/String;
    ...
    .line 132
    invoke-virtual/range {p0 .. p0}, Lo/getGoalMaxDateYear;->getTransactionDate()J

    move-result-wide v16

    .line 133
    invoke-virtual/range {p0 .. p0}, Lo/getGoalMaxDateYear;->getStatus()Lo/FragmentWelmaSbnHistoryOrderFilterBinding;
    ...
    .line 138
    invoke-virtual/range {p0 .. p0}, Lo/getGoalMaxDateYear;->getNotes()Lo/getGoalMaxDateYear$read;

    move-result-object v1

    invoke-virtual {v1}, Lo/getGoalMaxDateYear$read;->getEnglish()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lo/getGoalMaxDateYear$read;->getIndonesian()Ljava/util/List;
...
.method public static final invoke(Lo/getFlagRecommendation;Ljava/util/List;)Lo/MutualFundGoalTransactionListViewModel_HiltModulesKeyModule;
    ...
    .line 8068
    sget-object v9, Lo/MutualFundGoalTopUpDataSharedViewModel;->Companion:Lo/MutualFundGoalTopUpDataSharedViewModel$Companion;

    invoke-virtual {v8}, Lo/getFlagRecommendation$RemoteActionCompatParcelizer;->getFieldType()Ljava/lang/String;

    move-result-object v9

    invoke-static {v9}, Lo/MutualFundGoalTopUpDataSharedViewModel$Companion;->a(Ljava/lang/String;)Lo/MutualFundGoalTopUpDataSharedViewModel;

    move-result-object v23

    .line 8069
    invoke-virtual {v8}, Lo/getFlagRecommendation$RemoteActionCompatParcelizer;->getFieldLabelKey()Ljava/lang/String;
    ...
    .line 8070
    invoke-virtual {v8}, Lo/getFlagRecommendation$RemoteActionCompatParcelizer;->getDropdown()Ljava/util/List;
    ...
    .line 8162
    check-cast v9, Lo/getFlagRecommendation$a;

    .line 8070
    invoke-static {v9, v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    .line 9077
    invoke-virtual {v9}, Lo/getFlagRecommendation$a;->getListId()Ljava/lang/String;
    ...
    .line 9078
    invoke-virtual {v9}, Lo/getFlagRecommendation$a;->getListEn()Ljava/lang/String;
    ...
    .line 9079
    invoke-virtual {v9}, Lo/getFlagRecommendation$a;->getValue()Ljava/lang/String;

    move-result-object v2

    .line 9080
    invoke-virtual {v9}, Lo/getFlagRecommendation$a;->getOrder()I
    ...
    .line 9076
    new-instance v5, Lo/MutualFundGoalStopRSPConfirmationViewModel;

    invoke-direct {v5, v14, v1, v2, v9}, Lo/MutualFundGoalStopRSPConfirmationViewModel;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .line 8071
    :goto_4
    invoke-virtual {v8}, Lo/getFlagRecommendation$RemoteActionCompatParcelizer;->getOrder()Ljava/lang/Integer;
    ...
    new-instance v16, Lo/getPrivilegeFlag;
    ...
    invoke-direct/range {v16 .. v22}, Lo/getPrivilegeFlag;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public static final read(Lo/getTotalAmountTrx;)Lo/MutualFundSwitchingConfirmationViewModel;
    .locals 10
