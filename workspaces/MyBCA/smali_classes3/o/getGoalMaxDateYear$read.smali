.class public final Lo/getGoalMaxDateYear$read;
...
.method public final synthetic RemoteActionCompatParcelizer(Lo/functionTypeAnnotationsRenderer_delegatelambda1;Lo/renderVisibility;Lo/filterOutOverridden;)V
    ...
    .line 1000
    iget-object v0, p0, Lo/getGoalMaxDateYear$read;->english:Ljava/util/List;
    ...
    new-instance v0, Lo/getFeeTrx;

    invoke-direct {v0}, Lo/getFeeTrx;-><init>()V

    iget-object v1, p0, Lo/getGoalMaxDateYear$read;->english:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Lo/getGoalMaxDateYear$read;->indonesian:Ljava/util/List;
    ...
    new-instance p3, Lo/getRspFrequencyRemaining;

    invoke-direct {p3}, Lo/getRspFrequencyRemaining;-><init>()V
...
.method public final synthetic invoke(Lo/functionTypeAnnotationsRenderer_delegatelambda1;Lo/renderTypeParameter;Lo/createTypeCheckerState;)V
    ...
    iput-object v0, p0, Lo/getGoalMaxDateYear$read;->english:Ljava/util/List;

    goto :goto_0

    :cond_2
    iput-object v3, p0, Lo/getGoalMaxDateYear$read;->english:Ljava/util/List;
    ...
    new-instance v0, Lo/getRspFrequencyRemaining;

    invoke-direct {v0}, Lo/getRspFrequencyRemaining;-><init>()V
    ...
    iput-object v0, p0, Lo/getGoalMaxDateYear$read;->indonesian:Ljava/util/List;

    goto :goto_0

    :cond_4
    iput-object v3, p0, Lo/getGoalMaxDateYear$read;->indonesian:Ljava/util/List;
