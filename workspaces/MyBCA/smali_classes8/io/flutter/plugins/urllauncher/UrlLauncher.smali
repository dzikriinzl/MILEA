...
.method private static openCustomTab(Landroid/content/Context;Landroid/net/Uri;Landroid/os/Bundle;Lio/flutter/plugins/urllauncher/Messages$BrowserOptions;)Z
    ...
    .line 152
    new-instance v0, Lo/setImageResource$RemoteActionCompatParcelizer;

    invoke-direct {v0}, Lo/setImageResource$RemoteActionCompatParcelizer;-><init>()V
    ...
    invoke-virtual {v0, p3}, Lo/setImageResource$RemoteActionCompatParcelizer;->invoke(Z)Lo/setImageResource$RemoteActionCompatParcelizer;

    move-result-object p3

    invoke-virtual {p3}, Lo/setImageResource$RemoteActionCompatParcelizer;->RemoteActionCompatParcelizer()Lo/setImageResource;

    move-result-object p3

    .line 154
    iget-object v0, p3, Lo/setImageResource;->write:Landroid/content/Intent;
    ...
    .line 1482
    :try_start_0
    iget-object p2, p3, Lo/setImageResource;->write:Landroid/content/Intent;

    invoke-virtual {p2, p1}, Landroid/content/Intent;->setData(Landroid/net/Uri;)Landroid/content/Intent;

    .line 1483
    iget-object p1, p3, Lo/setImageResource;->write:Landroid/content/Intent;

    iget-object p2, p3, Lo/setImageResource;->a:Landroid/os/Bundle;

    invoke-static {p0, p1, p2}, Landroidx/core/content/ContextCompat;->RemoteActionCompatParcelizer(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;)V
    :try_end_0
