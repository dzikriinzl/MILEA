...
.method private popSystemNavigator()V
    ...
    instance-of v1, v0, Lo/addOnConfigurationChangedListener;

    if-eqz v1, :cond_1

    .line 503
    check-cast v0, Lo/addOnConfigurationChangedListener;
...
.method private setSystemChromeApplicationSwitcherDescription(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$AppSwitcherDescription;)V
    ...
    .line 228
    invoke-static {}, Lo/DefinitelyNotNullTypeCompanion;->MediaBrowserCompatCustomActionResultReceiver()V
    ...
    invoke-static {v0, v1, p1}, Lo/DefinitelyNotNullTypeCompanion;->write(Ljava/lang/String;II)Landroid/app/ActivityManager$TaskDescription;
...
.method private setSystemChromeSystemUIOverlayStyle(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SystemChromeStyle;)V
    ...
    invoke-direct {v2, v0, v1}, Lo/updateCoordinatorui_release;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    .line 431
    :cond_1
    invoke-virtual {v2, v3}, Lo/updateCoordinatorui_release;->read(Z)V

    goto :goto_0

    .line 426
    :cond_2
    invoke-virtual {v2, v5}, Lo/updateCoordinatorui_release;->read(Z)V
    ...
    invoke-static {v0, v1}, Lo/_init_lambda2;->a(Landroid/view/Window;Z)V
    ...
    .line 465
    :cond_6
    invoke-virtual {v2, v3}, Lo/updateCoordinatorui_release;->RemoteActionCompatParcelizer(Z)V

    goto :goto_1

    .line 460
    :cond_7
    invoke-virtual {v2, v5}, Lo/updateCoordinatorui_release;->RemoteActionCompatParcelizer(Z)V
    ...
    invoke-static {v0, v1}, Lo/DefinitelyNotNullTypeCompanion;->invoke(Landroid/view/Window;I)V
    ...
    .line 485
    invoke-static {v0, v1}, Lo/_init_lambda2;->invoke(Landroid/view/Window;Z)V
