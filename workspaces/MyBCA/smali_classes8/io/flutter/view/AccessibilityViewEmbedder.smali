...
.method private copyAccessibilityFields(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    .line 261
    invoke-static {p1}, Lo/setWriteObserver;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/util/List;

    move-result-object v0

    invoke-static {p2, v0}, Lo/ime;->invoke(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/util/List;)V

    .line 262
    invoke-static {p1}, Lo/setWriteObserver;->RemoteActionCompatParcelizer(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-static {p2, v0}, Lo/ime;->invoke(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V

    .line 263
    invoke-static {p1}, Lo/ime;->RemoteActionCompatParcelizer(Landroid/view/accessibility/AccessibilityNodeInfo;)Z

    move-result p1

    invoke-static {p2, p1}, Lo/ime;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
