...
# instance fields
.field private final callback:Lo/getValueimpl;
...
# direct methods
.method public constructor <init>(Lo/getValueimpl;Lcom/google/firebase/perf/transport/TransportManager;Lcom/google/firebase/perf/util/Timer;J)V
    .locals 0
    ...
    .line 41
    iput-object p1, p0, Lcom/google/firebase/perf/network/InstrumentOkHttpEnqueueCallback;->callback:Lo/getValueimpl;
...
# virtual methods
.method public onFailure(Lo/isInNanosimpl;Ljava/io/IOException;)V
    .locals 3

    .line 49
    invoke-interface {p1}, Lo/isInNanosimpl;->invoke()Lo/getMillisecondsUwyO8pcannotations;
    ...
    .line 63
    iget-object v0, p0, Lcom/google/firebase/perf/network/InstrumentOkHttpEnqueueCallback;->callback:Lo/getValueimpl;

    invoke-interface {v0, p1, p2}, Lo/getValueimpl;->onFailure(Lo/isInNanosimpl;Ljava/io/IOException;)V

    return-void
.end method

.method public onResponse(Lo/isInNanosimpl;Lo/getMillisecondsUwyO8pc;)V
    .locals 7
    ...
    invoke-interface {v0, p1, p2}, Lo/getValueimpl;->onResponse(Lo/isInNanosimpl;Lo/getMillisecondsUwyO8pc;)V
