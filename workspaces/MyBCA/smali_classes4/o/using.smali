...
.method public constructor <init>(Lo/functionTypeAnnotationsRenderer_delegatelambda1;Lo/createTypeCheckerState;Lo/filterOutOverridden;)V
    ...
    .line 33
    iput-object p1, p0, Lo/using;->a:Lo/functionTypeAnnotationsRenderer_delegatelambda1;

    .line 34
    iput-object p2, p0, Lo/using;->read:Lo/createTypeCheckerState;

    .line 35
    iput-object p3, p0, Lo/using;->RemoteActionCompatParcelizer:Lo/filterOutOverridden;
...
.method public final RemoteActionCompatParcelizer(Lo/renderTypeParameter;)Ljava/lang/Object;
    ...
    :cond_0
    new-instance v0, Lo/range;

    invoke-direct {v0}, Lo/range;-><init>()V

    iget-object v1, p0, Lo/using;->a:Lo/functionTypeAnnotationsRenderer_delegatelambda1;

    iget-object v2, p0, Lo/using;->read:Lo/createTypeCheckerState;

    invoke-virtual {v0, v1, p1, v2}, Lo/range;->write(Lo/functionTypeAnnotationsRenderer_delegatelambda1;Lo/renderTypeParameter;Lo/createTypeCheckerState;)V
...
.method public final a(Lo/renderVisibility;Ljava/lang/Object;)V
    ...
    :cond_0
    check-cast p2, Lo/range;

    iget-object v0, p0, Lo/using;->a:Lo/functionTypeAnnotationsRenderer_delegatelambda1;

    iget-object v1, p0, Lo/using;->RemoteActionCompatParcelizer:Lo/filterOutOverridden;

    invoke-virtual {p2, v0, p1, v1}, Lo/range;->a(Lo/functionTypeAnnotationsRenderer_delegatelambda1;Lo/renderVisibility;Lo/filterOutOverridden;)V
