.class public final Lo/copyToRealmIfNeeded;
...
.method public constructor <init>(Lo/checkForAddRemoveListener;)V
    ...
    .line 12
    iput-object p1, p0, Lo/copyToRealmIfNeeded;->RemoteActionCompatParcelizer:Lo/checkForAddRemoveListener;
...
.method public final synthetic RemoteActionCompatParcelizer(Ljava/lang/Object;)Lo/_type_delegatelambda0;
    ...
    .line 4020
    invoke-virtual {p1}, Lo/copyToRealmIfNeeded$read;->read()Lo/getValueAtIndex;
    ...
    .line 4021
    iget-object v1, p0, Lo/copyToRealmIfNeeded;->RemoteActionCompatParcelizer:Lo/checkForAddRemoveListener;

    .line 4022
    invoke-virtual {p1}, Lo/copyToRealmIfNeeded$read;->invoke()Ljava/lang/String;

    move-result-object v3

    .line 4023
    invoke-virtual {p1}, Lo/copyToRealmIfNeeded$read;->a()Z

    move-result v4

    .line 4021
    invoke-interface {v1, v3, v4}, Lo/checkForAddRemoveListener;->RemoteActionCompatParcelizer(Ljava/lang/String;Z)Lo/_type_delegatelambda0;

    move-result-object v1

    .line 4024
    new-instance v3, Lo/CompactOnLaunchCallback;

    new-instance v4, Lo/copyToRealm;

    invoke-direct {v4, p1, v2}, Lo/copyToRealm;-><init>(Lo/copyToRealmIfNeeded$read;Ljava/util/List;)V

    invoke-direct {v3, v4}, Lo/CompactOnLaunchCallback;-><init>(Lkotlin/jvm/functions/Function1;)V
