.class final Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;
...
.method constructor <init>(Ljava/util/List;Lo/getTargetTable;Landroidx/compose/runtime/MutableIntState;Landroidx/compose/runtime/MutableState;)V
    ...
    .line 65354
    iput-object p1, p0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->a:Ljava/util/List;

    iput-object p2, p0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->RemoteActionCompatParcelizer:Lo/getTargetTable;

    iput-object p3, p0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->read:Landroidx/compose/runtime/MutableIntState;

    iput-object p4, p0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->invoke:Landroidx/compose/runtime/MutableState;
...
.method public final synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v3, "com.bca.mybca.omni.android.welma.ut.presentation.views.MutualFundGoalProductDetailContent.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (MutualFundGoalProductDetailContent.kt:419)"
    ...
    :cond_1
    iget-object v1, v0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->a:Ljava/util/List;

    check-cast v1, Ljava/lang/Iterable;

    iget-object v15, v0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->RemoteActionCompatParcelizer:Lo/getTargetTable;

    iget-object v13, v0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->read:Landroidx/compose/runtime/MutableIntState;

    iget-object v12, v0, Lo/nativeRawDescriptor$AudioAttributesImplApi21Parcelizer$a$read$invoke$invoke;->invoke:Landroidx/compose/runtime/MutableState;
    ...
    .line 3431
    :cond_6
    new-instance v7, Lo/maximumDecimal128;
    ...
    invoke-direct/range {v2 .. v7}, Lo/maximumDecimal128;-><init>(Ljava/util/List;Ljava/lang/String;ILandroidx/compose/runtime/MutableState;Landroidx/compose/runtime/MutableIntState;)V
