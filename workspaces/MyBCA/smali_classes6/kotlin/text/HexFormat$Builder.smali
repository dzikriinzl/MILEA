...
.method public final build()Lkotlin/text/HexFormat;
    ...
    .line 761
    iget-object v1, p0, Lkotlin/text/HexFormat$Builder;->_bytes:Lkotlin/text/HexFormat$BytesHexFormat$Builder;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lkotlin/text/HexFormat$BytesHexFormat$Builder;->build$kotlin_stdlib()Lkotlin/text/HexFormat$BytesHexFormat;
    ...
    .line 762
    :cond_1
    iget-object v2, p0, Lkotlin/text/HexFormat$Builder;->_number:Lkotlin/text/HexFormat$NumberHexFormat$Builder;

    if-eqz v2, :cond_2

    invoke-virtual {v2}, Lkotlin/text/HexFormat$NumberHexFormat$Builder;->build$kotlin_stdlib()Lkotlin/text/HexFormat$NumberHexFormat;
    ...
    .line 759
    :cond_3
    new-instance v3, Lkotlin/text/HexFormat;

    invoke-direct {v3, v0, v1, v2}, Lkotlin/text/HexFormat;-><init>(ZLkotlin/text/HexFormat$BytesHexFormat;Lkotlin/text/HexFormat$NumberHexFormat;)V
