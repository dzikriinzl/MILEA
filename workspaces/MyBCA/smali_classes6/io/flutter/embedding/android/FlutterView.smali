...
.field private final windowInfoListener:Lo/TransparentObserverSnapshot;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lio/flutter/embedding/android/FlutterImageView;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterView;->windowInfoListener:Lo/TransparentObserverSnapshot;
...
.method public constructor <init>(Landroid/content/Context;Lio/flutter/embedding/android/RenderMode;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterView;->windowInfoListener:Lo/TransparentObserverSnapshot;
...
.method private init()V
    ...
    .line 391
    invoke-static {p0, v0}, Lo/getEnumEntryAnnotation;->RemoteActionCompatParcelizer(Lio/flutter/embedding/android/FlutterView;I)V
...
.method protected createWindowInfoRepo()Lio/flutter/embedding/android/WindowInfoRepositoryCallbackAdapterWrapper;
    ...
    .line 489
    :try_start_0
    new-instance v0, Lo/PathIteratorPreApi34Impl;

    sget-object v1, Lo/createInternalPathIterator;->read:Lo/createInternalPathIterator$read;
    ...
    invoke-virtual {v1, v2}, Lo/createInternalPathIterator$read;->a(Landroid/content/Context;)Lo/createInternalPathIterator;

    move-result-object v1

    invoke-direct {v0, v1}, Lo/PathIteratorPreApi34Impl;-><init>(Lo/createInternalPathIterator;)V

    new-instance v1, Lio/flutter/embedding/android/WindowInfoRepositoryCallbackAdapterWrapper;

    invoke-direct {v1, v0}, Lio/flutter/embedding/android/WindowInfoRepositoryCallbackAdapterWrapper;-><init>(Lo/PathIteratorPreApi34Impl;)V
    :try_end_0
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    .line 685
    invoke-static {p1}, Lo/setWriteObserver;->iI_(Landroid/view/WindowInsets;)Landroid/graphics/Insets;
    ...
    invoke-static {v1}, Lo/_init_lambda2;->bx_(Landroid/graphics/Insets;)I
    ...
    invoke-static {v1}, Lo/_init_lambda2;->bz_(Landroid/graphics/Insets;)I
    ...
    invoke-static {v1}, Lo/_init_lambda2;->bA_(Landroid/graphics/Insets;)I
    ...
    invoke-static {v1}, Lo/_init_lambda2;->s_(Landroid/graphics/Insets;)I
    ...
    .line 699
    invoke-static {}, Lo/setWriteObserver;->invoke()I
    ...
    .line 702
    invoke-static {}, Lo/setWriteObserver;->read()I
    ...
    .line 704
    :cond_4
    invoke-static {p1, v3}, Lo/setWriteObserver;->iB_(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {p1, v1}, Lo/setWriteObserver;->iB_(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    .line 717
    invoke-static {}, Lo/setWriteObserver;->IconCompatParcelizer()I
    ...
    .line 726
    invoke-static {p1}, Lo/setWriteObserver;->il_(Landroid/view/WindowInsets;)Landroid/view/DisplayCutout;
    ...
    .line 728
    invoke-static {p1}, Lo/getEnumEntryAnnotation;->kc_(Landroid/view/DisplayCutout;)Landroid/graphics/Insets;
    ...
    .line 732
    invoke-static {p1}, Lo/setFlags;->jK_(Landroid/view/DisplayCutout;)I
    ...
    .line 736
    invoke-static {p1}, Lo/setFlags;->jW_(Landroid/view/DisplayCutout;)I
    ...
    .line 740
    invoke-static {p1}, Lo/setFlags;->jV_(Landroid/view/DisplayCutout;)I
    ...
    invoke-static/range {v3 .. v9}, Lo/setFlags;->read(IIII[Ljava/lang/Object;II)Ljava/lang/Object;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/FlutterView;->windowInfoListener:Lo/TransparentObserverSnapshot;

    .line 514
    invoke-virtual {v1, v0, v2, v3}, Lio/flutter/embedding/android/WindowInfoRepositoryCallbackAdapterWrapper;->addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lo/TransparentObserverSnapshot;)V
...
.method protected onDetachedFromWindow()V
    ...
    .line 527
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterView;->windowInfoListener:Lo/TransparentObserverSnapshot;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/WindowInfoRepositoryCallbackAdapterWrapper;->removeWindowLayoutInfoListener(Lo/TransparentObserverSnapshot;)V
...
.method sendUserSettingsToFlutter()V
    ...
    .line 1475
    invoke-static {v1}, Lo/getEnumEntryAnnotation;->read(Landroid/view/textservice/TextServicesManager;)Ljava/util/List;
    ...
    .line 1487
    invoke-static {v4}, Lo/getEnumEntryAnnotation;->write(Landroid/view/textservice/TextServicesManager;)Z
...
.method protected setWindowInfoListenerDisplayFeatures(Lo/internalPathIteratorSize;)V
    .locals 6
    ...
    check-cast v1, Lo/WrongNestedHierarchyViolation;
    ...
    .line 548
    invoke-interface {v1}, Lo/WrongNestedHierarchyViolation;->write()Landroid/graphics/Rect;
    ...
    .line 551
    instance-of v2, v1, Lo/WrongFragmentContainerViolation;
    ...
    check-cast v2, Lo/WrongFragmentContainerViolation;

    .line 555
    invoke-interface {v2}, Lo/WrongFragmentContainerViolation;->invoke()Lo/WrongFragmentContainerViolation$invoke;

    move-result-object v3

    sget-object v4, Lo/WrongFragmentContainerViolation$invoke;->RemoteActionCompatParcelizer:Lo/WrongFragmentContainerViolation$invoke;
    ...
    .line 560
    :goto_1
    invoke-interface {v2}, Lo/WrongFragmentContainerViolation;->a()Lo/WrongFragmentContainerViolation$read;

    move-result-object v4

    sget-object v5, Lo/WrongFragmentContainerViolation$read;->a:Lo/WrongFragmentContainerViolation$read;
    ...
    .line 584
    invoke-static {p1}, Lo/getEnumEntryAnnotation;->kj_(Landroid/view/DisplayCutout;)Ljava/util/List;
