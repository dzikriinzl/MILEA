...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/firebase/components/ComponentDiscovery$read;,
        Lcom/google/firebase/components/ComponentDiscovery$write;
    }
.end annotation
...
.field private final retriever:Lcom/google/firebase/components/ComponentDiscovery$write;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/firebase/components/ComponentDiscovery$write<",
            "TT;>;"
...
# direct methods
.method constructor <init>(Ljava/lang/Object;Lcom/google/firebase/components/ComponentDiscovery$write;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    .line 70
    iput-object p2, p0, Lcom/google/firebase/components/ComponentDiscovery;->retriever:Lcom/google/firebase/components/ComponentDiscovery$write;
...
.method public static forContext(Landroid/content/Context;Ljava/lang/Class;)Lcom/google/firebase/components/ComponentDiscovery;
    ...
    new-instance v1, Lcom/google/firebase/components/ComponentDiscovery$read;

    const/4 v2, 0x0

    invoke-direct {v1, p1, v2}, Lcom/google/firebase/components/ComponentDiscovery$read;-><init>(Ljava/lang/Class;B)V

    invoke-direct {v0, p0, v1}, Lcom/google/firebase/components/ComponentDiscovery;-><init>(Ljava/lang/Object;Lcom/google/firebase/components/ComponentDiscovery$write;)V
...
.method public final discover()Ljava/util/List;
    ...
    .line 81
    iget-object v1, p0, Lcom/google/firebase/components/ComponentDiscovery;->retriever:Lcom/google/firebase/components/ComponentDiscovery$write;

    iget-object v2, p0, Lcom/google/firebase/components/ComponentDiscovery;->context:Ljava/lang/Object;

    invoke-interface {v1, v2}, Lcom/google/firebase/components/ComponentDiscovery$write;->RemoteActionCompatParcelizer(Ljava/lang/Object;)Ljava/util/List;
