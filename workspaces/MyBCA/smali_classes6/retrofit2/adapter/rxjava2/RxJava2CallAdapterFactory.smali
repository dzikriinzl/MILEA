...
# direct methods
.method private constructor <init>(Lo/getProjectionKind;Z)V
    .locals 0
    .param p1    # Lo/getProjectionKind;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 89
    iput-object p1, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;->scheduler:Lo/getProjectionKind;
...
.method public static create()Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;
    ...
    invoke-direct {v0, v1, v2}, Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;-><init>(Lo/getProjectionKind;Z)V
...
.method public static createWithScheduler(Lo/getProjectionKind;)Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;-><init>(Lo/getProjectionKind;Z)V
...
.method public final get(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Lretrofit2/Retrofit;)Lretrofit2/CallAdapter;
    ...
    .line 98
    const-class p3, Lo/LazyWrappedTypeLambda0;
    ...
    iget-object v2, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;->scheduler:Lo/getProjectionKind;
    ...
    invoke-direct/range {v0 .. v9}, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;-><init>(Ljava/lang/reflect/Type;Lo/getProjectionKind;ZZZZZZZ)V

    return-object p1

    .line 105
    :cond_0
    const-class p3, Lo/NotNullSimpleType;
    ...
    .line 106
    :goto_0
    const-class p3, Lo/_type_delegatelambda0;
    ...
    .line 108
    :goto_2
    const-class p3, Lo/SimpleTypeWithEnhancement;
    ...
    iget-object v4, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapterFactory;->scheduler:Lo/getProjectionKind;
    ...
    invoke-direct/range {v2 .. v11}, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;-><init>(Ljava/lang/reflect/Type;Lo/getProjectionKind;ZZZZZZZ)V
