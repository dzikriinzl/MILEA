...
.method protected createMessage([Ljava/lang/String;)Lio/netty/handler/codec/http/HttpMessage;
    ...
    .line 118
    invoke-static {v0}, Lio/netty/handler/codec/http/HttpVersion;->valueOf(Ljava/lang/String;)Lio/netty/handler/codec/http/HttpVersion;
    ...
    new-instance v3, Lio/netty/handler/codec/http/HttpResponseStatus;
    ...
    invoke-direct {v3, v1, p1}, Lio/netty/handler/codec/http/HttpResponseStatus;-><init>(ILjava/lang/String;)V

    iget-boolean p1, p0, Lio/netty/handler/codec/http/HttpResponseDecoder;->validateHeaders:Z

    invoke-direct {v2, v0, v3, p1}, Lio/netty/handler/codec/http/DefaultHttpResponse;-><init>(Lio/netty/handler/codec/http/HttpVersion;Lio/netty/handler/codec/http/HttpResponseStatus;Z)V
