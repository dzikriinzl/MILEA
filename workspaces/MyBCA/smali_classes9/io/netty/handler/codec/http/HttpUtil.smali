...
.field static final EMPTY_HEADERS:Lio/netty/handler/codec/http/EmptyHttpHeaders;
...
.method private static $$c(SSI)Ljava/lang/String;
    ...
    sget-object v0, Lio/netty/handler/codec/http/HttpUtil;->$$a:[B
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/netty/handler/codec/http/HttpUtil;->$$a:[B

    const/16 v0, 0x79

    sput v0, Lio/netty/handler/codec/http/HttpUtil;->$$b:I

    const/4 v0, 0x0

    sput v0, Lio/netty/handler/codec/http/HttpUtil;->$10:I

    const/4 v1, 0x1

    sput v1, Lio/netty/handler/codec/http/HttpUtil;->$11:I

    sput v0, Lio/netty/handler/codec/http/HttpUtil;->read:I

    sput v1, Lio/netty/handler/codec/http/HttpUtil;->RemoteActionCompatParcelizer:I

    sput v0, Lio/netty/handler/codec/http/HttpUtil;->invoke:I

    sput v1, Lio/netty/handler/codec/http/HttpUtil;->a:I

    invoke-static {}, Lio/netty/handler/codec/http/HttpUtil;->a()V

    .line 40
    new-instance v2, Lio/netty/handler/codec/http/EmptyHttpHeaders;

    invoke-direct {v2}, Lio/netty/handler/codec/http/EmptyHttpHeaders;-><init>()V

    sput-object v2, Lio/netty/handler/codec/http/HttpUtil;->EMPTY_HEADERS:Lio/netty/handler/codec/http/EmptyHttpHeaders;
    ...
    sput-object v2, Lio/netty/handler/codec/http/HttpUtil;->CHARSET_EQUALS:Lio/netty/util/AsciiString;
    ...
    invoke-static {v1, v2, v3, v4}, Lio/netty/handler/codec/http/HttpUtil;->b(Z[I[B[Ljava/lang/Object;)V
    ...
    sget v0, Lio/netty/handler/codec/http/HttpUtil;->a:I

    add-int/lit8 v0, v0, 0x33

    rem-int/lit16 v1, v0, 0x80

    sput v1, Lio/netty/handler/codec/http/HttpUtil;->invoke:I
...
.method static a()V
    ...
    sput-object v0, Lio/netty/handler/codec/http/HttpUtil;->write:[C
...
.method private static b(Z[I[B[Ljava/lang/Object;)V
    ...
    .line 170
    sget-object v8, Lio/netty/handler/codec/http/HttpUtil;->write:[C
    ...
    .line 181
    sget v12, Lio/netty/handler/codec/http/HttpUtil;->$11:I

    add-int/lit8 v12, v12, 0x2d

    rem-int/lit16 v13, v12, 0x80

    sput v13, Lio/netty/handler/codec/http/HttpUtil;->$10:I
    ...
    sget v17, Lio/netty/handler/codec/http/HttpUtil;->$$b:I
    ...
    invoke-static {v9, v10, v2}, Lio/netty/handler/codec/http/HttpUtil;->$$c(SSI)Ljava/lang/String;
    ...
    .line 220
    sget v8, Lio/netty/handler/codec/http/HttpUtil;->$10:I

    add-int/lit8 v8, v8, 0x3b

    rem-int/lit16 v9, v8, 0x80

    sput v9, Lio/netty/handler/codec/http/HttpUtil;->$11:I
    ...
    sget-object v11, Lio/netty/handler/codec/http/HttpUtil;->$$a:[B
    ...
    invoke-static {v11, v14, v15}, Lio/netty/handler/codec/http/HttpUtil;->$$c(SSI)Ljava/lang/String;
    ...
    invoke-static {v13, v14, v15}, Lio/netty/handler/codec/http/HttpUtil;->$$c(SSI)Ljava/lang/String;
    ...
    .line 181
    sget v2, Lio/netty/handler/codec/http/HttpUtil;->$10:I

    add-int/lit8 v2, v2, 0x55

    rem-int/lit16 v8, v2, 0x80

    sput v8, Lio/netty/handler/codec/http/HttpUtil;->$11:I
    ...
    sput v3, Lio/netty/handler/codec/http/HttpUtil;->$11:I
...
.method public static getContentLength(Lio/netty/handler/codec/http/HttpMessage;J)J
    ...
    .line 191
    sget p0, Lio/netty/handler/codec/http/HttpUtil;->read:I

    add-int/lit8 p0, p0, 0x3

    rem-int/lit16 p1, p0, 0x80

    sput p1, Lio/netty/handler/codec/http/HttpUtil;->RemoteActionCompatParcelizer:I
...
.method private static getWebSocketContentLength(Lio/netty/handler/codec/http/HttpMessage;)I
    ...
    .line 220
    invoke-virtual {v1, p0}, Lio/netty/handler/codec/http/HttpHeaders;->contains(Ljava/lang/CharSequence;)Z
    ...
    sput v2, Lio/netty/handler/codec/http/HttpUtil;->RemoteActionCompatParcelizer:I
    ...
    .line 228
    sget p0, Lio/netty/handler/codec/http/HttpUtil;->RemoteActionCompatParcelizer:I

    add-int/lit8 p0, p0, 0x39

    rem-int/lit16 v2, p0, 0x80

    sput v2, Lio/netty/handler/codec/http/HttpUtil;->read:I
...
.method public static is100ContinueExpected(Lio/netty/handler/codec/http/HttpMessage;)Z
    ...
    sput v1, Lio/netty/handler/codec/http/HttpUtil;->read:I
    ...
    sget v1, Lio/netty/handler/codec/http/HttpUtil;->read:I
...
.method public static isContentLengthSet(Lio/netty/handler/codec/http/HttpMessage;)Z
    ...
    sget v1, Lio/netty/handler/codec/http/HttpUtil;->RemoteActionCompatParcelizer:I
...
.method private static isExpectHeaderValid(Lio/netty/handler/codec/http/HttpMessage;)Z
    ...
    invoke-virtual {p0, v1}, Lio/netty/handler/codec/http/HttpVersion;->compareTo(Lio/netty/handler/codec/http/HttpVersion;)I
...
.method public static isKeepAlive(Lio/netty/handler/codec/http/HttpMessage;)Z
    ...
    invoke-virtual {p0, v1}, Lio/netty/util/AsciiString;->contentEqualsIgnoreCase(Ljava/lang/CharSequence;)Z
...
.method public static isTransferEncodingChunked(Lio/netty/handler/codec/http/HttpMessage;)Z
    ...
    invoke-virtual {p0, v1, v3, v2}, Lio/netty/handler/codec/http/HttpHeaders;->contains(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method static isUnsupportedExpectation(Lio/netty/handler/codec/http/HttpMessage;)Z
    ...
    sput v3, Lio/netty/handler/codec/http/HttpUtil;->read:I
...
.method public static setTransferEncodingChunked(Lio/netty/handler/codec/http/HttpMessage;Z)V
    ...
    invoke-virtual {p1, v1}, Lio/netty/handler/codec/http/HttpHeaders;->getAll(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    .line 346
    sget v3, Lio/netty/handler/codec/http/HttpUtil;->RemoteActionCompatParcelizer:I

    add-int/lit8 v3, v3, 0xf

    rem-int/lit16 v4, v3, 0x80

    sput v4, Lio/netty/handler/codec/http/HttpUtil;->read:I
    ...
    .line 339
    sget-object p1, Lio/netty/handler/codec/http/HttpHeaderValues;->CHUNKED:Lio/netty/util/AsciiString;
    ...
    invoke-virtual {p0, p1, v1}, Lio/netty/handler/codec/http/HttpHeaders;->set(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Lio/netty/handler/codec/http/HttpHeaders;
