...
.method public static read(Landroidx/versionedparcelable/VersionedParcel;)Landroidx/media2/session/LibraryResult;
    ...
    .line 15
    iget v1, v0, Landroidx/media2/session/LibraryResult;->AudioAttributesImplApi26Parcelizer:I
    ...
    iput v1, v0, Landroidx/media2/session/LibraryResult;->AudioAttributesImplApi26Parcelizer:I

    .line 16
    iget-wide v1, v0, Landroidx/media2/session/LibraryResult;->invoke:J
    ...
    iput-wide v1, v0, Landroidx/media2/session/LibraryResult;->invoke:J

    .line 17
    iget-object v1, v0, Landroidx/media2/session/LibraryResult;->AudioAttributesImplApi21Parcelizer:Landroidx/media2/common/MediaItem;
    ...
    iput-object v1, v0, Landroidx/media2/session/LibraryResult;->AudioAttributesImplApi21Parcelizer:Landroidx/media2/common/MediaItem;

    .line 18
    iget-object v1, v0, Landroidx/media2/session/LibraryResult;->write:Landroidx/media2/session/MediaLibraryService$LibraryParams;
    ...
    iput-object v1, v0, Landroidx/media2/session/LibraryResult;->write:Landroidx/media2/session/MediaLibraryService$LibraryParams;

    .line 19
    iget-object v1, v0, Landroidx/media2/session/LibraryResult;->a:Landroidx/media2/common/ParcelImplListSlice;
    ...
    iput-object p0, v0, Landroidx/media2/session/LibraryResult;->a:Landroidx/media2/common/ParcelImplListSlice;
...
.method public static write(Landroidx/media2/session/LibraryResult;Landroidx/versionedparcelable/VersionedParcel;)V
    ...
    .line 28
    iget v0, p0, Landroidx/media2/session/LibraryResult;->AudioAttributesImplApi26Parcelizer:I
    ...
    .line 29
    iget-wide v0, p0, Landroidx/media2/session/LibraryResult;->invoke:J
    ...
    .line 31
    iget-object v0, p0, Landroidx/media2/session/LibraryResult;->write:Landroidx/media2/session/MediaLibraryService$LibraryParams;
    ...
    .line 32
    iget-object p0, p0, Landroidx/media2/session/LibraryResult;->a:Landroidx/media2/common/ParcelImplListSlice;

    const/4 v0, 0x5

    invoke-virtual {p1, p0, v0}, Landroidx/versionedparcelable/VersionedParcel;->read(Landroid/os/Parcelable;I)V
