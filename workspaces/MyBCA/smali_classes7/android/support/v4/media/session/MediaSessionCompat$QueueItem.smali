...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$read;
    }
.end annotation
...
.method private constructor <init>(Landroid/media/session/MediaSession$QueueItem;Landroid/support/v4/media/MediaDescriptionCompat;J)V
    ...
    .line 2177
    iput-wide p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->RemoteActionCompatParcelizer:J
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-wide v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->RemoteActionCompatParcelizer:J
...
.method public static a(Ljava/util/List;)Ljava/util/List;
    ...
    .line 2269
    invoke-static {v1}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->write(Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;
...
.method public static write(Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;
    .locals 4
    ...
    .line 2246
    invoke-static {p0}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$read;->a(Landroid/media/session/MediaSession$QueueItem;)Landroid/media/MediaDescription;
    ...
    .line 2249
    invoke-static {p0}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem$read;->RemoteActionCompatParcelizer(Landroid/media/session/MediaSession$QueueItem;)J
...
.method public final invoke()Landroid/support/v4/media/MediaDescriptionCompat;
    .locals 1
...
.method public final toString()Ljava/lang/String;
    ...
    iget-wide v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->RemoteActionCompatParcelizer:J
...
.method public final write()J
    ...
    .line 2197
    iget-wide v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->RemoteActionCompatParcelizer:J
