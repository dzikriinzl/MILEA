...
# static fields
.field private static final BACK_PRESSURE_STRATEGY:Lo/getRefinedConstructor;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/realm/rx/RealmObservableFactory;->BACK_PRESSURE_STRATEGY:Lo/getRefinedConstructor;
...
.method private getScheduler()Lo/getProjectionKind;
    .locals 2
    ...
    .line 226
    invoke-static {v0}, Lo/buildStarProjectionTypeByTypeParameters;->invoke(Landroid/os/Looper;)Lo/getProjectionKind;
...
# virtual methods
.method public changesetsFrom(Lio/realm/DynamicRealm;Lio/realm/DynamicRealmObject;)Lo/SimpleTypeWithEnhancement;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 717
    invoke-direct {p0}, Lio/realm/rx/RealmObservableFactory;->getScheduler()Lo/getProjectionKind;
    ...
    invoke-static {v1}, Lo/SimpleTypeWithEnhancement;->create(Lo/makeSimpleTypeDefinitelyNotNullOrNotNull;)Lo/SimpleTypeWithEnhancement;

    move-result-object p1

    .line 753
    invoke-virtual {p1, v0}, Lo/SimpleTypeWithEnhancement;->subscribeOn(Lo/getProjectionKind;)Lo/SimpleTypeWithEnhancement;

    move-result-object p1

    invoke-virtual {p1, v0}, Lo/SimpleTypeWithEnhancement;->unsubscribeOn(Lo/getProjectionKind;)Lo/SimpleTypeWithEnhancement;
...
.method public changesetsFrom(Lio/realm/DynamicRealm;Lio/realm/RealmList;)Lo/SimpleTypeWithEnhancement;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public changesetsFrom(Lio/realm/DynamicRealm;Lio/realm/RealmResults;)Lo/SimpleTypeWithEnhancement;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public changesetsFrom(Lio/realm/Realm;Lio/realm/RealmList;)Lo/SimpleTypeWithEnhancement;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public changesetsFrom(Lio/realm/Realm;Lio/realm/RealmModel;)Lo/SimpleTypeWithEnhancement;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
...
.method public changesetsFrom(Lio/realm/Realm;Lio/realm/RealmResults;)Lo/SimpleTypeWithEnhancement;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public from(Lio/realm/DynamicRealm;)Lo/NotNullSimpleType;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 139
    invoke-static {p1}, Lo/NotNullSimpleType;->a(Ljava/lang/Object;)Lo/NotNullSimpleType;
    ...
    sget-object p1, Lio/realm/rx/RealmObservableFactory;->BACK_PRESSURE_STRATEGY:Lo/getRefinedConstructor;

    invoke-static {v1, p1}, Lo/NotNullSimpleType;->invoke(Lo/NotNullTypeParameter;Lo/getRefinedConstructor;)Lo/NotNullSimpleType;

    move-result-object p1

    .line 172
    invoke-virtual {p1, v0}, Lo/NotNullSimpleType;->a(Lo/getProjectionKind;)Lo/NotNullSimpleType;

    move-result-object p1

    invoke-virtual {p1, v0}, Lo/NotNullSimpleType;->RemoteActionCompatParcelizer(Lo/getProjectionKind;)Lo/NotNullSimpleType;
...
.method public from(Lio/realm/DynamicRealm;Lio/realm/DynamicRealmObject;)Lo/NotNullSimpleType;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 668
    invoke-static {p2}, Lo/NotNullSimpleType;->a(Ljava/lang/Object;)Lo/NotNullSimpleType;
    ...
    invoke-static {v2, p1}, Lo/NotNullSimpleType;->invoke(Lo/NotNullTypeParameter;Lo/getRefinedConstructor;)Lo/NotNullSimpleType;

    move-result-object p1

    .line 708
    invoke-virtual {p1, v1}, Lo/NotNullSimpleType;->a(Lo/getProjectionKind;)Lo/NotNullSimpleType;

    move-result-object p1

    invoke-virtual {p1, v1}, Lo/NotNullSimpleType;->RemoteActionCompatParcelizer(Lo/getProjectionKind;)Lo/NotNullSimpleType;
...
.method public from(Lio/realm/DynamicRealm;Lio/realm/RealmList;)Lo/NotNullSimpleType;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public from(Lio/realm/DynamicRealm;Lio/realm/RealmResults;)Lo/NotNullSimpleType;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public from(Lio/realm/Realm;)Lo/NotNullSimpleType;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public from(Lio/realm/Realm;Lio/realm/RealmList;)Lo/NotNullSimpleType;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public from(Lio/realm/Realm;Lio/realm/RealmModel;)Lo/NotNullSimpleType;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
...
.method public from(Lio/realm/Realm;Lio/realm/RealmResults;)Lo/NotNullSimpleType;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public from(Lio/realm/DynamicRealm;Lio/realm/RealmQuery;)Lo/_type_delegatelambda0;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public from(Lio/realm/Realm;Lio/realm/RealmQuery;)Lo/_type_delegatelambda0;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
