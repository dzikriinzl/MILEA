...
.method public static valueOf(Lio/realm/RealmModel;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/RealmModelOperator;

    invoke-direct {v0, p0}, Lio/realm/RealmModelOperator;-><init>(Lio/realm/RealmModel;)V
...
.method public static valueOf(Ljava/lang/Boolean;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/BooleanRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/BooleanRealmAnyOperator;-><init>(Ljava/lang/Boolean;)V
...
.method public static valueOf(Ljava/lang/Byte;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/IntegerRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/IntegerRealmAnyOperator;-><init>(Ljava/lang/Byte;)V
...
.method public static valueOf(Ljava/lang/Double;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/DoubleRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/DoubleRealmAnyOperator;-><init>(Ljava/lang/Double;)V
...
.method public static valueOf(Ljava/lang/Float;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/FloatRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/FloatRealmAnyOperator;-><init>(Ljava/lang/Float;)V
...
.method public static valueOf(Ljava/lang/Integer;)Lio/realm/RealmAny;
    ...
    invoke-direct {v0, p0}, Lio/realm/IntegerRealmAnyOperator;-><init>(Ljava/lang/Integer;)V
...
.method public static valueOf(Ljava/lang/Long;)Lio/realm/RealmAny;
    ...
    invoke-direct {v0, p0}, Lio/realm/IntegerRealmAnyOperator;-><init>(Ljava/lang/Long;)V
...
.method public static valueOf(Ljava/lang/Short;)Lio/realm/RealmAny;
    ...
    invoke-direct {v0, p0}, Lio/realm/IntegerRealmAnyOperator;-><init>(Ljava/lang/Short;)V
...
.method public static valueOf(Ljava/lang/String;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/StringRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/StringRealmAnyOperator;-><init>(Ljava/lang/String;)V
...
.method public static valueOf(Ljava/util/Date;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/DateRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/DateRealmAnyOperator;-><init>(Ljava/util/Date;)V
...
.method public static valueOf(Ljava/util/UUID;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/UUIDRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/UUIDRealmAnyOperator;-><init>(Ljava/util/UUID;)V
...
.method public static valueOf(Lorg/bson/types/Decimal128;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/Decimal128RealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/Decimal128RealmAnyOperator;-><init>(Lorg/bson/types/Decimal128;)V
...
.method public static valueOf(Lorg/bson/types/ObjectId;)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/ObjectIdRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/ObjectIdRealmAnyOperator;-><init>(Lorg/bson/types/ObjectId;)V
...
.method public static valueOf([B)Lio/realm/RealmAny;
    ...
    :cond_0
    new-instance v0, Lio/realm/BinaryRealmAnyOperator;

    invoke-direct {v0, p0}, Lio/realm/BinaryRealmAnyOperator;-><init>([B)V
