...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v13, v0, v3}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v1, Lio/realm/RealmAny$Type;->INTEGER:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v2, v4, v5, v0, v3}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v2, Lio/realm/RealmAny$Type;->BOOLEAN:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v3, v5, v6, v0, v4}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v3, Lio/realm/RealmAny$Type;->STRING:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v4, v6, v7, v0, v5}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v4, Lio/realm/RealmAny$Type;->BINARY:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v5, v7, v8, v0, v6}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V
    ...
    invoke-direct {v6, v8, v9, v0, v7}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v6, Lio/realm/RealmAny$Type;->FLOAT:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v7, v9, v10, v0, v8}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v7, Lio/realm/RealmAny$Type;->DOUBLE:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v8, v10, v11, v0, v9}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v8, Lio/realm/RealmAny$Type;->DECIMAL128:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v9, v11, v12, v0, v10}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v9, Lio/realm/RealmAny$Type;->OBJECT_ID:Lio/realm/RealmAny$Type;

    .line 583
    new-instance v10, Lio/realm/RealmAny$Type;

    sget-object v0, Lio/realm/RealmFieldType;->TYPED_LINK:Lio/realm/RealmFieldType;
    ...
    invoke-direct {v10, v12, v14, v0, v11}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v10, Lio/realm/RealmAny$Type;->OBJECT:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v11, v14, v15, v0, v12}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v11, Lio/realm/RealmAny$Type;->UUID:Lio/realm/RealmAny$Type;
    ...
    invoke-direct {v12, v15, v0, v14, v14}, Lio/realm/RealmAny$Type;-><init>(Ljava/lang/String;ILio/realm/RealmFieldType;Ljava/lang/Class;)V

    sput-object v12, Lio/realm/RealmAny$Type;->NULL:Lio/realm/RealmAny$Type;

    .line 573
    filled-new-array/range {v1 .. v12}, [Lio/realm/RealmAny$Type;
