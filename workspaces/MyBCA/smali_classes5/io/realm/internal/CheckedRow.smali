...
.method public getModelList(J)Lio/realm/internal/OsList;
    ...
    invoke-virtual {v1, p1, p2}, Lio/realm/internal/Table;->getColumnName(J)Ljava/lang/String;
    ...
    const-string v1, "Field \'%s\' is not a \'RealmList\'."
...
.method public getModelMap(J)Lio/realm/internal/OsMap;
    ...
    const-string v1, "Field \'%s\' is not a \'RealmDictionary\'."
...
.method public getValueList(JLio/realm/RealmFieldType;)Lio/realm/internal/OsList;
    ...
    const-string p3, "The type of field \'%1$s\' is not \'RealmFieldType.%2$s\'."
