...
.method public static createRowWithPrimaryKey(Lio/realm/internal/Table;JLjava/lang/Object;)J
    ...
    const-string v2, "Primary key value is not an ObjectId: "
    ...
    const-string v2, "Primary key value is not an UUID: "
...
.method public static createWithPrimaryKey(Lio/realm/internal/Table;Ljava/lang/Object;)Lio/realm/internal/UncheckedRow;
    ...
    .line 203
    new-instance v8, Lio/realm/internal/UncheckedRow;
    ...
    invoke-direct {v8, v7, p0, v0, v1}, Lio/realm/internal/UncheckedRow;-><init>(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)V
    ...
    .line 208
    iget-object v9, v1, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/NativeContext;
    ...
    invoke-direct {p1, v9, p0, v0, v1}, Lio/realm/internal/UncheckedRow;-><init>(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)V
    ...
    .line 213
    :goto_3
    iget-object p1, v1, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/NativeContext;
    ...
    invoke-direct {v7, p1, p0, v0, v1}, Lio/realm/internal/UncheckedRow;-><init>(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)V
    ...
    invoke-direct {p1, p0}, Lio/realm/exceptions/RealmException;-><init>(Ljava/lang/String;)V
...
.method public static native nativeCreateEmbeddedObject(JJJ)J
.end method

.method public static native nativeCreateNewObject(J)J
.end method

.method public static native nativeCreateNewObjectWithLongPrimaryKey(JJJJZ)J
.end method

.method public static native nativeCreateNewObjectWithObjectIdPrimaryKey(JJJLjava/lang/String;)J
...
.method public static native nativeCreateNewObjectWithUUIDPrimaryKey(JJJLjava/lang/String;)J
    .param p6    # Ljava/lang/String;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    .end param
...
.method public static native nativeCreateRow(J)J
.end method

.method public static native nativeCreateRowWithLongPrimaryKey(JJJJZ)J
.end method

.method public static native nativeCreateRowWithObjectIdPrimaryKey(JJJLjava/lang/String;)J
    .param p6    # Ljava/lang/String;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    .end param
...
.method public static native nativeCreateRowWithUUIDPrimaryKey(JJJLjava/lang/String;)J
    .param p6    # Ljava/lang/String;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    .end param
...
.method public addListener(Lio/realm/RealmModel;Lio/realm/RealmObjectChangeListener;)V
    ...
    invoke-virtual {p0, v0, v1}, Lio/realm/internal/OsObject;->nativeStartListening(J)V
...
.method public native nativeStartListening(J)V
.end method

.method public native nativeStopListening(J)V
.end method
...
.method public removeListener(Lio/realm/RealmModel;)V
    ...
    invoke-virtual {p0, v0, v1}, Lio/realm/internal/OsObject;->nativeStopListening(J)V
...
.method public removeListener(Lio/realm/RealmModel;Lio/realm/RealmObjectChangeListener;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/realm/internal/OsObject;->nativeStopListening(J)V
