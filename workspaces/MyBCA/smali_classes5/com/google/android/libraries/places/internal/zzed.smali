...
.method public static final zza(Lcom/google/android/libraries/places/internal/zzec;)Lcom/google/android/libraries/places/api/net/FindAutocompletePredictionsResponse;
    ...
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq;->zzf()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq;->zzd()Ljava/lang/Integer;
    ...
    .line 11
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq;->zzc()Lcom/google/android/libraries/places/internal/zziy;

    move-result-object v5

    invoke-static {v5}, Lcom/google/android/libraries/places/internal/zzex;->zzb(Ljava/util/List;)Ljava/util/List;

    move-result-object v5

    .line 12
    invoke-static {v5}, Lcom/google/android/libraries/places/internal/zzex;->zza(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq;->zze()Ljava/lang/String;

    move-result-object v5

    .line 14
    invoke-static {v5}, Lcom/google/android/libraries/places/internal/zzil;->zzb(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 15
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq;->zzb()Lcom/google/android/libraries/places/internal/zziy;

    move-result-object v5

    invoke-static {v5}, Lcom/google/android/libraries/places/internal/zzed;->zzb(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq;->zza()Lcom/google/android/libraries/places/internal/zzdq$zza;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq$zza;->zzc()Ljava/lang/String;
    ...
    .line 18
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq$zza;->zza()Lcom/google/android/libraries/places/internal/zziy;
    ...
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq$zza;->zzd()Ljava/lang/String;
    ...
    .line 21
    invoke-virtual {v3}, Lcom/google/android/libraries/places/internal/zzdq$zza;->zzb()Lcom/google/android/libraries/places/internal/zziy;

    move-result-object v3

    invoke-static {v3}, Lcom/google/android/libraries/places/internal/zzed;->zzb(Ljava/util/List;)Ljava/util/List;
