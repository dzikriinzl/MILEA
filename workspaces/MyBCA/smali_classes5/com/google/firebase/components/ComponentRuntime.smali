...
.field private final eventBus:Lo/RopeByteStringRopeInputStream;
...
.method private constructor <init>(Ljava/util/concurrent/Executor;Ljava/lang/Iterable;Ljava/util/Collection;Lcom/google/firebase/components/ComponentRegistrarProcessor;)V
    ...
    .line 85
    new-instance v0, Lo/RopeByteStringRopeInputStream;

    invoke-direct {v0, p1}, Lo/RopeByteStringRopeInputStream;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object v0, p0, Lcom/google/firebase/components/ComponentRuntime;->eventBus:Lo/RopeByteStringRopeInputStream;
    ...
    const-class v1, Lo/RopeByteStringRopeInputStream;
...
.method synthetic constructor <init>(Ljava/util/concurrent/Executor;Ljava/lang/Iterable;Ljava/util/Collection;Lcom/google/firebase/components/ComponentRegistrarProcessor;Lcom/google/firebase/components/ComponentRuntime$4;)V
    .locals 0
...
.method private discoverComponents(Ljava/util/List;)V
    ...
    .line 147
    invoke-static {p1}, Lo/getLeafByLeft;->read(Ljava/util/List;)V
    ...
    .line 151
    invoke-static {v1}, Lo/getLeafByLeft;->read(Ljava/util/List;)V
...
.method private doInitializeEagerComponents(Ljava/util/Map;Z)V
    ...
    .line 326
    :cond_2
    iget-object p1, p0, Lcom/google/firebase/components/ComponentRuntime;->eventBus:Lo/RopeByteStringRopeInputStream;
    ...
    .line 1123
    :try_start_0
    iget-object p2, p1, Lo/RopeByteStringRopeInputStream;->invoke:Ljava/util/Queue;
    ...
    .line 1125
    iput-object v0, p1, Lo/RopeByteStringRopeInputStream;->invoke:Ljava/util/Queue;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1130
    invoke-virtual {p1, v0}, Lo/RopeByteStringRopeInputStream;->publish(Lcom/google/firebase/events/Event;)V
...
.method static synthetic lambda$processInstanceComponents$2(Lo/readSkipInternal;Lcom/google/firebase/inject/Provider;)V
    .locals 2
    ...
    .line 2065
    :try_start_0
    iget-object v0, p0, Lo/readSkipInternal;->read:Lcom/google/firebase/inject/Deferred$DeferredHandler;

    const/4 v1, 0x0

    .line 2066
    iput-object v1, p0, Lo/readSkipInternal;->read:Lcom/google/firebase/inject/Deferred$DeferredHandler;

    .line 2067
    iput-object p1, p0, Lo/readSkipInternal;->write:Lcom/google/firebase/inject/Provider;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static synthetic lambda$processSetComponents$3(Lo/SmallSortedMap;Lcom/google/firebase/inject/Provider;)V
    .locals 1
    ...
    .line 3061
    :try_start_0
    iget-object v0, p0, Lo/SmallSortedMap;->write:Ljava/util/Set;

    if-nez v0, :cond_0

    .line 3062
    iget-object v0, p0, Lo/SmallSortedMap;->a:Ljava/util/Set;
...
.method private processDependencies()V
    ...
    invoke-static {v5}, Lo/SmallSortedMap;->a(Ljava/util/Collection;)Lo/SmallSortedMap;
    ...
    invoke-static {}, Lo/readSkipInternal;->read()Lo/readSkipInternal;
...
.method private processInstanceComponents(Ljava/util/List;)Ljava/util/List;
    ...
    .line 213
    check-cast v3, Lo/readSkipInternal;

    .line 216
    new-instance v4, Lcom/google/firebase/components/ComponentRuntime$$ExternalSyntheticLambda3;

    invoke-direct {v4, v3, v2}, Lcom/google/firebase/components/ComponentRuntime$$ExternalSyntheticLambda3;-><init>(Lo/readSkipInternal;Lcom/google/firebase/inject/Provider;)V
...
.method private processSetComponents()Ljava/util/List;
    ...
    invoke-static {v2}, Lo/SmallSortedMap;->a(Ljava/util/Collection;)Lo/SmallSortedMap;
    ...
    check-cast v3, Lo/SmallSortedMap;
    ...
    invoke-direct {v5, v3, v4}, Lcom/google/firebase/components/ComponentRuntime$$ExternalSyntheticLambda4;-><init>(Lo/SmallSortedMap;Lcom/google/firebase/inject/Provider;)V
...
.method public getDeferred(Lcom/google/firebase/components/Qualified;)Lcom/google/firebase/inject/Deferred;
    ...
    .line 274
    :cond_0
    instance-of v0, p1, Lo/readSkipInternal;

    if-eqz v0, :cond_1

    .line 275
    check-cast p1, Lo/readSkipInternal;

    return-object p1

    .line 277
    :cond_1
    invoke-static {p1}, Lo/readSkipInternal;->a(Lcom/google/firebase/inject/Provider;)Lo/readSkipInternal;
...
.method synthetic lambda$discoverComponents$0$com-google-firebase-components-ComponentRuntime(Lcom/google/firebase/components/Component;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p1, p0}, Lo/advanceIfCurrentPieceFullyRead;-><init>(Lcom/google/firebase/components/Component;Lcom/google/firebase/components/ComponentContainer;)V
...
.method public setOfProvider(Lcom/google/firebase/components/Qualified;)Lcom/google/firebase/inject/Provider;
    ...
    check-cast p1, Lo/SmallSortedMap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
