...
.field private static fcmServiceConn:Lo/accessrenderName;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 56
    new-instance p1, Lo/WireFormatFieldType;

    invoke-direct {p1}, Lo/WireFormatFieldType;-><init>()V
...
.method private static bindToMessagingService(Landroid/content/Context;Landroid/content/Intent;Z)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->getServiceConnection(Landroid/content/Context;Ljava/lang/String;)Lo/accessrenderName;
    ...
    .line 130
    invoke-static {p0, v0, p1}, Lo/accessrenderFunction;->a(Landroid/content/Context;Lo/accessrenderName;Landroid/content/Intent;)V

    goto :goto_0

    .line 132
    :cond_0
    invoke-virtual {v0, p1}, Lo/accessrenderName;->write(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 141
    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/tasks/Task;->RemoteActionCompatParcelizer(Ljava/util/concurrent/Executor;Lo/access12600;)Lcom/google/android/gms/tasks/Task;
...
.method private static getServiceConnection(Landroid/content/Context;Ljava/lang/String;)Lo/accessrenderName;
    .locals 2
    ...
    .line 148
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->fcmServiceConn:Lo/accessrenderName;

    if-nez v1, :cond_0

    .line 149
    new-instance v1, Lo/accessrenderName;

    invoke-direct {v1, p0, p1}, Lo/accessrenderName;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v1, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->fcmServiceConn:Lo/accessrenderName;

    .line 151
    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->fcmServiceConn:Lo/accessrenderName;
...
.method public static setServiceConnection(Lo/accessrenderName;)V
    .locals 1
    ...
    .line 175
    :try_start_0
    sput-object p0, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->fcmServiceConn:Lo/accessrenderName;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public startMessagingService(Landroid/content/Context;Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 90
    invoke-static {p1, p2, v2}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->bindToMessagingService(Landroid/content/Context;Landroid/content/Intent;Z)Lcom/google/android/gms/tasks/Task;
    ...
    .line 95
    invoke-static {v0, v2}, Lo/access18602;->write(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/google/android/gms/tasks/Task;->write(Ljava/util/concurrent/Executor;Lo/access12600;)Lcom/google/android/gms/tasks/Task;
