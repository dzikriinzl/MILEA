...
# static fields
.field private static final FRAME_METRICS_AGGREGATOR_CLASSNAME:Ljava/lang/String; = "o.unsupported"
...
.field private final frameMetricsAggregator:Lo/unsupported;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    .line 69
    new-instance v0, Lo/unsupported;

    invoke-direct {v0}, Lo/unsupported;-><init>()V

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    invoke-direct {p0, p1, v0, v1}, Lcom/google/firebase/perf/application/FrameMetricsRecorder;-><init>(Landroid/app/Activity;Lo/unsupported;Ljava/util/Map;)V

    return-void
.end method

.method constructor <init>(Landroid/app/Activity;Lo/unsupported;Ljava/util/Map;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 78
    iput-object p2, p0, Lcom/google/firebase/perf/application/FrameMetricsRecorder;->frameMetricsAggregator:Lo/unsupported;
...
.method private snapshot()Lcom/google/firebase/perf/util/Optional;
    ...
    .line 198
    :cond_0
    iget-object v0, p0, Lcom/google/firebase/perf/application/FrameMetricsRecorder;->frameMetricsAggregator:Lo/unsupported;

    .line 1300
    iget-object v0, v0, Lo/unsupported;->invoke:Lo/unsupported$RemoteActionCompatParcelizer;

    invoke-virtual {v0}, Lo/unsupported$RemoteActionCompatParcelizer;->read()[Landroid/util/SparseIntArray;
...
.method public start()V
    ...
    invoke-virtual {v0, v1}, Lo/unsupported$RemoteActionCompatParcelizer;->write(Landroid/app/Activity;)V
...
.method public stop()Lcom/google/firebase/perf/util/Optional;
    ...
    .line 112
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/perf/application/FrameMetricsRecorder;->frameMetricsAggregator:Lo/unsupported;

    iget-object v2, p0, Lcom/google/firebase/perf/application/FrameMetricsRecorder;->activity:Landroid/app/Activity;

    .line 3242
    iget-object v1, v1, Lo/unsupported;->invoke:Lo/unsupported$RemoteActionCompatParcelizer;

    invoke-virtual {v1, v2}, Lo/unsupported$RemoteActionCompatParcelizer;->invoke(Landroid/app/Activity;)[Landroid/util/SparseIntArray;
    :try_end_0
    ...
    invoke-virtual {v1}, Lo/unsupported$RemoteActionCompatParcelizer;->write()[Landroid/util/SparseIntArray;
